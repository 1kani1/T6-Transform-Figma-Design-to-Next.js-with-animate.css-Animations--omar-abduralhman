...
const Desktop7 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[3769px] overflow-hidden text-left text-5xl text-white font-inter">
      ...
      <div className="absolute top-[48px] left-[924px] rounded-48xl bg-orange box-border w-[101px] h-10 border-[1px] border-solid border-orange" />
      <div
      ...
      <div className="absolute top-[57px] left-[924px] text-xl text-black text-center inline-block w-[101px] h-5">
        Support
      </div>
      <div
      ...
      <b className="absolute top-[977px] left-[344px] inline-block text-center w-[1006px] h-[113px]">
      ...
      <b className="absolute top-[1487px] left-[152px] inline-block w-[390px] h-[93px]">
        Sponsored by the most Iconic Arabic only brands.
      </b>
      <b className="absolute top-[1861px] left-[172px] inline-block w-[390px] h-[45px]">
        Got a code to redeem?
      </b>
      <div className="absolute top-[1170px] left-[443px] text-xl font-semibold text-lightsteelblue text-center inline-block w-[760px] h-[85px]">
      ...
      <div className="absolute top-[1474px] left-[860px] text-sm font-semibold text-gainsboro inline-block w-[520px] h-[93px]">
      ...
      <div className="absolute top-[2190px] left-[37px] font-semibold inline-block w-[520px] h-[114px]">
        Hear what our customers say :)
      </div>
      <div className="absolute top-[1575px] left-[217px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1575px] left-[423px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1574px] left-[642px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1571px] left-[862px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1575px] left-[1118px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1572px] left-[1375px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1961px] left-[172px] rounded-82xl bg-black box-border w-[668px] h-[71px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1961px] left-[868px] rounded-82xl bg-orange box-border w-[130px] h-[71px] border-[1px] border-solid border-orange" />
      <div className="absolute top-[1982px] left-[196px] inline-block w-[130px] h-[29px]">
        Code
      </div>
      <div className="absolute top-[1982px] left-[886px] text-black text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <div className="absolute top-[2822px] left-[152px] bg-orange box-border w-[1376px] h-[316px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2901px] left-[549px] text-xs font-semibold text-black text-center inline-block w-[520px] h-[37px]">
        Join now our program and gain an unforgettable journey in improvising
        and adapting to arabic.
      </div>
      <div className="absolute top-[2856px] left-[549px] font-semibold text-black text-center inline-block w-[520px] h-10">
        What are you waiting for?
      </div>
      <div className="absolute top-[2965px] left-[516px] rounded-82xl bg-white box-border w-[668px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2965px] left-[1205px] rounded-82xl bg-black box-border w-[130px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2986px] left-[549px] text-black inline-block w-[130px] h-[29px]">
        Email
      </div>
      <div className="absolute top-[2986px] left-[1223px] text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <img
        className="absolute top-[1600px] left-[242px] w-[100px] h-[100px] object-cover"
        alt=""
        src="/2removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1579px] left-[431px] w-[134px] h-[134px] object-cover"
        alt=""
        src="/download--3-removebgpreview-1@2x.png"
      />
      <img
        className="absolute h-[1.75%] w-[5.59%] top-[42.9%] right-[55%] bottom-[55.35%] left-[39.41%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/download--1-removebgpreview-3@2x.png"
      />
      <img
        className="absolute top-[1593px] left-[812px] w-[250px] h-28 object-cover"
        alt=""
        src="/screenshot--211-removebgpreview-1-1@2x.png"
      />
      <img
        className="absolute top-[1574px] left-[1117px] w-[153px] h-[153px] object-cover"
        alt=""
        src="/download--19-removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1551px] left-[1356px] w-[188px] h-[188px] object-cover"
        alt=""
        src="/61457e92f8cc77657dfa2b46-artboard-16-copy-1@2x.png"
      />
      <div className="absolute top-[2348px] left-[172px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
      ...
      <div className="absolute top-[2347px] left-[688px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
            <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
      ...
      <div className="absolute top-[2348px] left-[1205px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
            <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
