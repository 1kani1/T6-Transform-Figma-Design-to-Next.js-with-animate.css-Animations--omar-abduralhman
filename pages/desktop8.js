...
const Desktop8 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[3769px] overflow-hidden text-left text-5xl text-white font-inter">
      ...
      <div className="absolute top-[48px] left-[413px] rounded-26xl bg-black box-border w-[774px] h-10 border-[1px] border-solid border-orange" />
      <div className="absolute top-[48px] left-[1086px] rounded-48xl bg-orange box-border w-[101px] h-10 border-[1px] border-solid border-orange" />
      <div
      ...
      <div className="absolute top-[57px] left-[1086px] text-xl text-black text-center inline-block w-[101px] h-5">
        More
      </div>
      ...
      <b className="absolute top-[1005px] left-[367px] inline-block text-center w-[1006px] h-[113px]">
      ...
      <b className="absolute top-[1515px] left-[175px] inline-block w-[390px] h-[93px]">
        Sponsored by the most Iconic Arabic only brands.
      </b>
      <b className="absolute top-[1889px] left-[195px] inline-block w-[390px] h-[45px]">
        Got a code to redeem?
      </b>
      <div className="absolute top-[1198px] left-[466px] text-xl font-semibold text-lightsteelblue text-center inline-block w-[760px] h-[85px]">
      ...
      <div className="absolute top-[1502px] left-[883px] text-sm font-semibold text-gainsboro inline-block w-[520px] h-[93px]">
      ...
      <div className="absolute top-[2218px] left-[60px] font-semibold inline-block w-[520px] h-[114px]">
        Hear what our customers say :)
      </div>
      <div className="absolute top-[1603px] left-[240px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1603px] left-[446px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1602px] left-[665px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1599px] left-[885px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1603px] left-[1141px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1600px] left-[1398px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1989px] left-[195px] rounded-82xl bg-black box-border w-[668px] h-[71px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1989px] left-[891px] rounded-82xl bg-orange box-border w-[130px] h-[71px] border-[1px] border-solid border-orange" />
      <div className="absolute top-[2010px] left-[219px] inline-block w-[130px] h-[29px]">
        Code
      </div>
      <div className="absolute top-[2010px] left-[909px] text-black text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <div className="absolute top-[2850px] left-[175px] bg-orange box-border w-[1376px] h-[316px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2929px] left-[572px] text-xs font-semibold text-black text-center inline-block w-[520px] h-[37px]">
        Join now our program and gain an unforgettable journey in improvising
        and adapting to arabic.
      </div>
      <div className="absolute top-[2884px] left-[572px] font-semibold text-black text-center inline-block w-[520px] h-10">
        What are you waiting for?
      </div>
      <div className="absolute top-[2993px] left-[539px] rounded-82xl bg-white box-border w-[668px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2993px] left-[1228px] rounded-82xl bg-black box-border w-[130px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[3014px] left-[572px] text-black inline-block w-[130px] h-[29px]">
        Email
      </div>
      <div className="absolute top-[3014px] left-[1246px] text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <img
        className="absolute top-[1628px] left-[265px] w-[100px] h-[100px] object-cover"
        alt=""
        src="/2removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1607px] left-[454px] w-[134px] h-[134px] object-cover"
        alt=""
        src="/download--3-removebgpreview-1@2x.png"
      />
      <img
        className="absolute h-[1.75%] w-[5.59%] top-[43.65%] right-[53.65%] bottom-[54.6%] left-[40.76%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/download--1-removebgpreview-3@2x.png"
      />
      <img
        className="absolute top-[1621px] left-[835px] w-[250px] h-28 object-cover"
        alt=""
        src="/screenshot--211-removebgpreview-1-1@2x.png"
      />
      <img
        className="absolute top-[1602px] left-[1140px] w-[153px] h-[153px] object-cover"
        alt=""
        src="/download--19-removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1579px] left-[1379px] w-[188px] h-[188px] object-cover"
        alt=""
        src="/61457e92f8cc77657dfa2b46-artboard-16-copy-1@2x.png"
      />
      <div className="absolute top-[2378.5px] left-[195px] w-[329px] flex flex-col items-start justify-start gap-[16px] text-base font-roboto">
      ...
      <div className="absolute top-[2375px] left-[711px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
      ...
      <div className="absolute top-[2388.5px] left-[1228px] w-[329px] flex flex-col items-start justify-start gap-[16px] text-base font-roboto">
        <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
          <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
