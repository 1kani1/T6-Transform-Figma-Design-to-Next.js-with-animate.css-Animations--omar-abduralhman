...
const Desktop4 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[3769px] overflow-hidden text-left text-5xl text-white font-inter">
      <div className="absolute top-[2097px] left-[-9px] bg-black w-[2579px] h-[613px]" />
      ...
      <b className="absolute top-[985px] left-[349px] inline-block text-center w-[1006px] h-[113px]">
      ...
      <b className="absolute top-[1495px] left-[157px] inline-block w-[390px] h-[93px]">
        Sponsored by the most Iconic Arabic only brands.
      </b>
      <b className="absolute top-[1869px] left-[177px] inline-block w-[390px] h-[45px]">
        Got a code to redeem?
      </b>
      <div className="absolute top-[1178px] left-[448px] text-xl font-semibold text-lightsteelblue text-center inline-block w-[760px] h-[85px]">
      ...
      <div className="absolute top-[1482px] left-[865px] text-sm font-semibold text-gainsboro inline-block w-[520px] h-[93px]">
      ...
      <div className="absolute top-[2198px] left-[42px] font-semibold inline-block w-[520px] h-[114px]">
        Hear what our customers say :)
      </div>
      <div className="absolute top-[1583px] left-[222px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1583px] left-[428px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1582px] left-[647px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1579px] left-[867px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1583px] left-[1123px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1580px] left-[1380px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1969px] left-[177px] rounded-82xl bg-black box-border w-[668px] h-[71px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1969px] left-[873px] rounded-82xl bg-orange box-border w-[130px] h-[71px] border-[1px] border-solid border-orange" />
      <div className="absolute top-[1990px] left-[201px] inline-block w-[130px] h-[29px]">
        Code
      </div>
      <div className="absolute top-[1990px] left-[891px] text-black text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <div className="absolute top-[2830px] left-[157px] bg-orange box-border w-[1376px] h-[316px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2909px] left-[554px] text-xs font-semibold text-black text-center inline-block w-[520px] h-[37px]">
        Join now our program and gain an unforgettable journey in improvising
        and adapting to arabic.
      </div>
      <div className="absolute top-[2864px] left-[554px] font-semibold text-black text-center inline-block w-[520px] h-10">
        What are you waiting for?
      </div>
      <div className="absolute top-[2973px] left-[521px] rounded-82xl bg-white box-border w-[668px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2973px] left-[1210px] rounded-82xl bg-black box-border w-[130px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2994px] left-[554px] text-black inline-block w-[130px] h-[29px]">
        Email
      </div>
      <div className="absolute top-[2994px] left-[1228px] text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <img
        className="absolute top-[1608px] left-[247px] w-[100px] h-[100px] object-cover"
        alt=""
        src="/2removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1587px] left-[436px] w-[134px] h-[134px] object-cover"
        alt=""
        src="/download--3-removebgpreview-1@2x.png"
      />
      <img
        className="absolute h-[1.75%] w-[5.59%] top-[43.11%] right-[54.71%] bottom-[55.13%] left-[39.71%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/download--1-removebgpreview-3@2x.png"
      />
      <img
        className="absolute top-[1601px] left-[817px] w-[250px] h-28 object-cover"
        alt=""
        src="/screenshot--211-removebgpreview-1-1@2x.png"
      />
      <img
        className="absolute top-[1582px] left-[1122px] w-[153px] h-[153px] object-cover"
        alt=""
        src="/download--19-removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1559px] left-[1361px] w-[188px] h-[188px] object-cover"
        alt=""
        src="/61457e92f8cc77657dfa2b46-artboard-16-copy-1@2x.png"
      />
      <div className="absolute top-[2370.5px] left-[201px] w-[329px] flex flex-col items-start justify-start gap-[16px] text-base font-roboto">
      ...
      <div className="absolute top-[2355px] left-[693px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
      ...
      <div className="absolute top-[2380.5px] left-[1234px] w-[329px] flex flex-col items-start justify-start gap-[16px] text-base font-roboto">
        <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
          <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
