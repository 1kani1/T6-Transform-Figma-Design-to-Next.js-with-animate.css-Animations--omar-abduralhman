...
const Desktop9 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[3769px] overflow-hidden text-left text-5xl text-white font-inter">
      ...
      <div className="absolute top-[48px] left-[413px] rounded-48xl bg-orange box-border w-[84px] h-10 border-[1px] border-solid border-orange" />
      <div
      ...
      <div className="absolute top-[58px] left-[405px] text-xl text-black text-center inline-block w-[101px] h-5">
        Home
      </div>
      <div
      ...
      <div
        className="absolute top-[57px] left-[749px] text-xl text-center inline-block w-[101px] h-5 cursor-pointer"
        onClick={onOffersTextClick}
      >
        Offers
      </div>
      <div
      ...
      <div className="absolute top-[124px] left-[1458px] rounded-[40px] bg-gainsboro w-[239px] h-[158px]" />
      <b className="absolute top-[990px] left-[353px] inline-block text-center w-[1006px] h-[113px]">
      ...
      <b className="absolute top-[1500px] left-[161px] inline-block w-[390px] h-[93px]">
        Sponsored by the most Iconic Arabic only brands.
      </b>
      <b className="absolute top-[1874px] left-[181px] inline-block w-[390px] h-[45px]">
        Got a code to redeem?
      </b>
      <div className="absolute top-[1183px] left-[452px] text-xl font-semibold text-lightsteelblue text-center inline-block w-[760px] h-[85px]">
      ...
      <div className="absolute top-[1487px] left-[869px] text-sm font-semibold text-gainsboro inline-block w-[520px] h-[93px]">
      ...
      <div className="absolute top-[2203px] left-[46px] font-semibold inline-block w-[520px] h-[114px]">
        Hear what our customers say :)
      </div>
      <div className="absolute top-[1588px] left-[226px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1588px] left-[432px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1587px] left-[651px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1584px] left-[871px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1588px] left-[1127px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1585px] left-[1384px] rounded-10xl bg-black box-border w-[150px] h-[150px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1974px] left-[181px] rounded-82xl bg-black box-border w-[668px] h-[71px] border-[1px] border-solid border-white" />
      <div className="absolute top-[1974px] left-[877px] rounded-82xl bg-orange box-border w-[130px] h-[71px] border-[1px] border-solid border-orange" />
      <div className="absolute top-[1995px] left-[205px] inline-block w-[130px] h-[29px]">
        Code
      </div>
      <div className="absolute top-[1995px] left-[895px] text-black text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <div className="absolute top-[2835px] left-[161px] bg-orange box-border w-[1376px] h-[316px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2914px] left-[558px] text-xs font-semibold text-black text-center inline-block w-[520px] h-[37px]">
        Join now our program and gain an unforgettable journey in improvising
        and adapting to arabic.
      </div>
      <div className="absolute top-[2869px] left-[558px] font-semibold text-black text-center inline-block w-[520px] h-10">
        What are you waiting for?
      </div>
      <div className="absolute top-[2978px] left-[525px] rounded-82xl bg-white box-border w-[668px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2978px] left-[1214px] rounded-82xl bg-black box-border w-[130px] h-[71px] border-[1px] border-solid border-black" />
      <div className="absolute top-[2999px] left-[558px] text-black inline-block w-[130px] h-[29px]">
        Email
      </div>
      <div className="absolute top-[2999px] left-[1232px] text-center inline-block w-[94px] h-[29px]">
        Apply
      </div>
      <img
        className="absolute top-[1613px] left-[251px] w-[100px] h-[100px] object-cover"
        alt=""
        src="/2removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1592px] left-[440px] w-[134px] h-[134px] object-cover"
        alt=""
        src="/download--3-removebgpreview-1@2x.png"
      />
      <img
        className="absolute h-[1.75%] w-[5.59%] top-[43.25%] right-[54.47%] bottom-[55%] left-[39.94%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/download--1-removebgpreview-3@2x.png"
      />
      <img
        className="absolute top-[1606px] left-[821px] w-[250px] h-28 object-cover"
        alt=""
        src="/screenshot--211-removebgpreview-1-1@2x.png"
      />
      <img
        className="absolute top-[1587px] left-[1126px] w-[153px] h-[153px] object-cover"
        alt=""
        src="/download--19-removebgpreview-1@2x.png"
      />
      <img
        className="absolute top-[1564px] left-[1365px] w-[188px] h-[188px] object-cover"
        alt=""
        src="/61457e92f8cc77657dfa2b46-artboard-16-copy-1@2x.png"
      />
      <div className="absolute top-[2361px] left-[181px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
      ...
      <div className="absolute top-[2360px] left-[697px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
            <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
      ...
      <div className="absolute top-[2361px] left-[1214px] rounded bg-gray-300 box-border w-[377px] h-[173px] flex flex-col items-start justify-center p-6 text-base font-roboto border-[1px] border-solid border-lightsteelblue">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
            <div className="relative rounded-61xl box-border w-16 h-16 border-[8px] border-solid border-gray-300">
